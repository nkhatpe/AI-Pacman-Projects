...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        for iteration in range(self.iterations):
            ...
            # Update the values after processing all states
    ...
    def computeQValueFromValues(self, state, action):
        ...
        q_value = sum(
            stateAndProb[1] * (self.mdp.getReward(state, action, stateAndProb[0]) +
    ...
    def computeActionFromValues(self, state):
        ...
        # Calculate Q-values for all actions and store in a dictionary
        action_values = {action: self.computeQValueFromValues(state, action) for action in actions}

        # Return action corresponding to the maximum Q-value
